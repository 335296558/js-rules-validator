...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.RuleValidator = factory());
  ...
  function isNativeStringType$1(type) {
  ...
  function isEmptyValue$1(value, type) {
    ...
    if (isNativeStringType$1(type) && typeof value === 'string' && !value) {
      return true;
    }
  ...
  function required(rule, value, source, errors, options, type) {
    if (rule.required && (!source.hasOwnProperty(rule.field) || isEmptyValue$1(value, type || rule.type))) {
  ...
  var create = function create(rules) {
    ...
    var _loop = function _loop(k) {
      ...
      functions[k] = function () {
        ...
        _construct$1(fieldValidate, options.concat([obj]));
      };
    };
  ...
  var RuleValidator = /*#__PURE__*/function () {
    function RuleValidator() {
      ...
      debug && console.log(Blue, 'messages ==>>', Schema.messages);
      debug && console.log(Blue, 'validators ==>>', Schema.validators);
      var create = RulesConfig.create,
          regulars = RulesConfig.regulars;
      var RulesFunctions = create(rules);
      this.regulars = regulars;
      Object.assign(Schema.validators, RulesFunctions);
    }
    /**
     * @param {*} rules
     * @param {*} query
