(function (global, factory) {
  ...
  (global = global || self, global.jsNvalidator = factory());
  ...
  var isNativeStringType$1 = function isNativeStringType(type) {
    return type === 'string' || type === 'url' || type === 'hex' || type === 'email' || type === 'date' || type === 'pattern';
  }; // isEmptyValue  搬运原库的


  var isEmptyValue$1 = function isEmptyValue(val, type) {
    ...
    if (isNativeStringType$1(type) && typeof val === 'string' && !val) {
      return true;
    }
